...
if __name__ == "__main__":
    ...
    # TEMPORARY: allows `MAX_EPOCHS=2 python distill_SPKD.py` for a quick
    ...
    resume_ckpt = find_latest_checkpoint('./checkpoint_SPKD')
    if resume_ckpt:
    ...
    torch.save(to_save,os.path.join('./checkpoint_SPKD', "SPKD_best_model.pth"))
