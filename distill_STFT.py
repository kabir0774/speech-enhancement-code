...
class KnowledgeDistillation(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        distill_loss = self.stft_loss(student_preds.squeeze(1),teacher_preds.squeeze(1))[1]
...
if __name__ == "__main__":
    ...
    # TEMPORARY: allows `MAX_EPOCHS=2 python distill_STFT.py` for a quick
    ...
    resume_ckpt = find_latest_checkpoint('./checkpoint_STFT')
    if resume_ckpt:
    ...
    torch.save(to_save,os.path.join('./checkpoint_STFT', "STFT_best_model.pth"))
